...
namespace MUA
{
    ...
    public class Parser
    {
        ...
        private int Parse(int startPosition, ref StringBuilder mystring, ref Regex haltexpression, char closure = '\0', bool evaluate = true)
        {
            ...
            var function = functionNameAscii.Match(parseString).Groups;
            ...
            {
                var specialMatch = haltexpression.Match(parseString);
        ...
        private int SquareParse(int readerPosition, ref StringBuilder mystring)
        {
            ...
            var startPosition = readerPosition;
            var parseLength = Parse(++readerPosition, ref mystring, ref specialCharSquareEndHalt, ']');
        ...
        private int PercentParse(int readerPosition, ref StringBuilder mystring)
        {
            ...
            var percentarg = mystring.ToString().Substring(startPosition, percentLen);
        ...
        private int FunctionParse(int readerPosition, ref StringBuilder mystring, string functionName)
        {
            ...
            var initialPosition = readerPosition;
            ...
            foreach (var argument in functionStack)
            {
