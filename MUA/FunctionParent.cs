...
namespace MUA
{
    ...
    public class FunctionParent : IFunction
    {
        ...
        /// </summary>
        /// <param name="player">The player executing the body, used for the sake of evaluating Permissions.</param>
        /// <param name="arguments">A Stack of MarkupStrings that represent the arguments.</param>
